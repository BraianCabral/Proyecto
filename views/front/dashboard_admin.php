...
$sql3 = "SELECT * FROM roles WHERE NOT nombre='Administrador'";
...
'
  ...
  <div class="container">
      ...
      while ($categoria = $result2->fetch_assoc()) {
        echo "
                <tr>
                        ...
                        <td>
                            <a href=\"../../controllers/eliminar_categoria.php?id={$categoria['id']}\">
                            <i class=\"fa fa-trash\" aria-hidden=\"true\"></i>
                            </a>
                        </td>
                        <td>
                            <a href=\"update_cat.php?id={$categoria['id']}\">
    ...
    ?>
    <a class="btn btn-light" href="agregar_cat.php" role="button">Agregar Categoria</a>
    ...
    if ($result3->num_rows == 0) {
      ...
      echo '
                <table class="table text-center table-bordered mt-5 mt-5">
                        <thead class="table-light">
                            <tr>
                            <th scope="col">Nº</th>
                            <th scope="col">Nombre</th>
                        ...
                        <tbody>
                        ';
      while ($rol = $result3->fetch_assoc()) {
        echo "
                <tr>
                        <th >{$rol['id']}</th>
                        <td>{$rol['nombre']}</td>
                        <td>
                            <a href=\"../../controllers/eliminar_rol.php?id={$rol['id']}\">
                            <i class=\"fa fa-trash\" aria-hidden=\"true\"></i>
                            </a>
                        </td>
                </tr>
    ...
    ?>
    <a href="agregar_rol.php" class="btn btn-light mb-5" role="button" aria-disabled="true">Agregar Rol</a>

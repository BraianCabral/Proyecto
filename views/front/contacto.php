...
?>
  ...
  <section class="gradient-custom py-3 py-md-5 py-xl-8">
    <div class="container">
      <div class="row justify-content-md-center">
        <div class="col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6">
          <h2 class="mb-4 display-5 text-center">Necesitas Ayuda?</h2>
          <p class="text-light mb-5 text-center lead fs-4">Nuestro equipo está disponible para brindar respuestas
            rápidas y útiles a todas las consultas. Puede comunicarse con nosotros por teléfono, correo electrónico o
            completando el
            formulario de contacto a continuación.</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="card rounded shadow-sm overflow-hidden border border-0 bg-dark bg-opacity-50">
            <div class="card-body p-0">
              <div class="row gy-3 gy-md-4 gy-lg-0">
                <div class="col-12 col-lg-6 bsb-overlay background-position-center background-size-cover"
                  style="--bsb-overlay-opacity: 0.7; background-image: url('../../public/img/banco.jpg');">
                  <div class="row align-items-lg-center justify-content-center h-100">
                    <div class="col-11 col-xl-10">
                      <div class="contact-info-wrapper py-4 py-xl-5">
                        <h2 class="h1 mb-3 text-light">Contáctenos</h2>
                        <p class="lead fs-4 text-light opacity-75 mb-4 mb-xxl-5">Siempre estamos buscando nuevos
                          clientes para trabajar con nosotros, ponte en
                          contacto con nosotros de alguna de las siguientes maneras.</p>
                        <div class="d-flex mb-4 mb-xxl-5">
                          ...
                          <div>
                            <h4 class="mb-3 text-light">Direccion</h4>
                            <address class="mb-0 text-light opacity-75">8014 Edith Blvd NE, Albuquerque, New York,
                        ...
                        <div class="row mb-4 mb-xxl-5">
                          <div class="col-12 col-xxl-6">
                            <div class="d-flex mb-4 mb-xxl-0">
                              ...
                              <div>
                                <h4 class="mb-3 text-light">Telefono</h4>
                                <p class="mb-0">
                          ...
                          <div class="col-12 col-xxl-6">
                            <div class="d-flex mb-0">
                              ...
                              <div>
                                ...
                                <p class="mb-0">
                                  <a class="link-light link-opacity-75 link-opacity-100-hover text-decoration-none"
                                    href="mailto:demo@yourdomain.com">banconacionalds@gmail.com</a>
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="d-flex">
                          ...
                          <div>
                            <h4 class="mb-3 text-light">Horario de apertura</h4>
                            <div class="d-flex mb-1">
                              <p class="text-light fw-bold mb-0 me-5">Lun - Vie</p>
                              <p class="text-light opacity-75 mb-0">9am - 5pm</p>
                            </div>
                            <div class="d-flex">
                              <p class="text-light fw-bold mb-0 me-5">Sab - Dom</p>
                      ...
                      <form action="#!">
                        <div class="row gy-4 gy-xl-5 p-4 p-xl-5">
                          <div class="col-12">
                            ...
                            <input type="text" class="form-control bg-transparent border-light" id="fullname"
                          ...
                          <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                              ...
                              <input type="email" class="form-control bg-transparent border-light" id="email"
                          ...
                          <div class="col-12 col-md-6">
                            ...
                            <div class="input-group">
                              ...
                              <input type="tel" class="form-control bg-transparent border-light" id="phone" name="phone"
                                value="">
                            </div>
                          </div>
                          <div class="col-12">
                            <label for="subject" class="form-label">Asunto <span class="text-danger">*</span></label>
                            <input type="text" class="form-control bg-transparent border-light" id="subject"
                              name="subject" value="" required>
                          </div>
                          <div class="col-12">
                            <label for="message" class="form-label">Mensaje <span class="text-danger">*</span></label>
                            <textarea class="form-control bg-transparent border-light" id="message" name="message"

...
<div class="container-fluid">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="bg-dark bg-opacity-50 rounded-4 container">
        <div class="m-5 p-3">
            <h2 class="text-light text-center">Agregar rol</h2>
            <hr class="w-75 mx-auto m-5">
            <form method="POST" action="../../controllers/registrar_rol.php">
                <div>
                    <input type="text" class="form-control bg-transparent border-light" placeholder="Rol" id="rol" name="rol" required>
                </div>
                <button type="submit" class="btn mt-4 btn-light mb-4">Agregar Rol</button>
            </form>
        </div>
    </div>
